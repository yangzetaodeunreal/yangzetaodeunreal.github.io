    ...
    messages: {
        "zh-CN": {
            ...
            home: {
                ...
                careerLine: "职业生涯故事线",
                contactMe: "联系我",
                shortIntro: "你好啊！<br>我叫杨泽韬，一个后端程序员，目前在厦门工作。<br>我也是一个天主教徒，相信工作也能造就一个人，并以社会福祉和弱势群体为方向付出贡献！<br><br><br>此致敬礼！<br><br>杨泽韬",
        ...
        en: {
            ...
            home: {
                ...
                shortIntro: 'Hi!<br>My name is Zetao Yang. I am a backend developer, currently located in Xiamen City, Fujian Province, China.<br>I am also a Catholic and believe that work can also build up a person and make contributions in the direction of social welfare and disadvantaged groups!<br><br><br>Best regards,<br>Zetao',
